...
const Editor = ({ onChange, value }) => {
  ...
  return (
    <div className={`bg-gray-200 h-full flex flex-col ${isFullScreen ? 'fixed p-8 top-0 left-0 right-0 bottom-0 z-50' : ''}`}>
      <div className="bg-gray-200 flex items-center justify-between mb-2 mx-5 px-4" id='editor-header'>
        <button className="text-xl font-bold py-2 px-4 rounded-lg bg-indigo-500 text-white" onClick={handleToggleFullScreen}>Editor</button>
        <div>
          <button
